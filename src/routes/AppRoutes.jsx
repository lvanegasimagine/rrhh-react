        ...
        <>
          <Navbar />
            <Routes>
              ...
              <Route path="nuevo-empleado" element={user ? <NuevoEmpleadoScreen /> : <LoginScreen/>} />
              <Route
                path="editar-empleado/:id"
                element={user ? <EditarEmpleadoScreen /> : <LoginScreen/>}
              />
              <Route path="listar-empleado" element={user ? <ListaEmpleadoScreen /> : <LoginScreen/>} />
              <Route
              ...
              />
              <Route path="nuevo-cargo" element={user ? <NuevoCargoScreen /> : <LoginScreen/>} />
              <Route path="editar-cargo/:id" element={user ? <EditarCargoScreen /> : <LoginScreen/>} />
              <Route path="listar-cargo" element={user ? <ListarCargoScreen /> : <LoginScreen/>} />
            </Routes>
        </>
      )}
      {/* <Navbar />
