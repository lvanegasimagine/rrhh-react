...
function Formulario({crearCita}) {
    ...
    // Funcion que se ejecuta cada q el usuario escribe en el input

    const actualizarState = (e) => {
        actualizarCita({
            ...cita,
            [e.target.name]: e.target.value // asigna el valor a cada uno de los input de acuerdo a su name
        })
    }
    ...
    const submitCita = (e) => {
        e.preventDefault(); // No envia mediante el url
    ...
    return (
        <Fragment>
            ...
            <form onSubmit={submitCita} autoComplete="false">
